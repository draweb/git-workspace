...
/**
 * Comando: gw remote add <nombre> -w <workspace> <url-ssh>
 * Uso: Agrega un remote con URL aliada al workspace y marca gwWorkspace.
 * Ejemplo: gw remote add origin -w draweb git@github.com:org/repo.git
 */
